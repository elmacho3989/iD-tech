...
public class EntityMod {
    ...
    public static void registerEntities(final RegistryEvent.Register<EntityType<?>> event){
        event.getRegistry().register(SithEntity.TYPE);
    }
    @SubscribeEvent
    public static void registerEntityEggs(final RegistryEvent.Register<Item> event) {
        event.getRegistry().register(SithEntity.EGG);
    }
    @SubscribeEvent
    public static void entityRenderers(final EntityRenderersEvent.RegisterRenderers event){
        event.registerEntityRenderer(SithEntity.TYPE,SithRenderFactory.INSTANCE);
    }
    ...
    public static void onAttributeCreate(EntityAttributeCreationEvent event) {
        event.put(SithEntity.TYPE,SithEntity.createAttributes().build());
    }
