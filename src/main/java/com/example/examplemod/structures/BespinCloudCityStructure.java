...
public class BespinCloudCityStructure extends StructureFeature<JigsawConfiguration> {
    public BespinCloudCityStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, BespinCloudCityStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!BespinCloudCityStructure.isFeatureChunk(context)) {
        ...
        if (structurePiecesGenerator.isPresent()) {
            ...
            BaseMod.LOGGER.log(Level.DEBUG, "Bespin Cloud City at {}", blockpos);
        }
